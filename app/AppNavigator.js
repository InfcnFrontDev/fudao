                ...
                <Drawer
                    ...
                    <AppRouter
                        ...
                        <Scene key="root">
                            ...
                            <Scene key="tabbar" tabs initial tabBarStyle={{ backgroundColor: '#eeeeee' }}>
                                <Scene key="home" component={Home} title="主页" hideNavBar icon={TabBarIcon}
                                       iconName='ios-home-outline' selectedIconName='ios-home'/>
                                <Scene key="article" component={Article} title="资讯" hideNavBar icon={TabBarIcon}
                                       iconName='ios-list-box-outline' selectedIconName='ios-list-box'/>
                                <Scene key="dynamic" component={Dynamic} title="动态" hideNavBar icon={TabBarIcon}
                                       iconName='ios-compass-outline' selectedIconName='ios-compass'/>
                                <Scene key="my" component={My} title="我的" hideNavBar icon={TabBarIcon}
