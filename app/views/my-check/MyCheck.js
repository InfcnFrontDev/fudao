...
const groupsTable = {
	"基本信息": "userInformation",
	"肝胆功能": "liverAndGallbladder",
	"肿瘤标志物": "tumorMarker",
	"尿常规": "urineRoutine",
	"耳鼻喉科": "otolaryngology",
	"眼科": "ophthalmology",
	"血常规": "routineBloodTest",
	"口腔科": "dentalDepartment",
	"CT": "ct",
	"内科": "medicalDepartment",
	"心电图": "ecg",
	"外科": "surgical",
	"血脂类": "lipfieldClass",
	"肾功能": "renalFunction",
...
class MyCheck extends PureComponent {
	...
	_renderRow(rowData, sectionId, rowId) {
		let {loginUser} = this.props,
			text = '',
			tab = loginUser[groupsTable[sectionId]];
		...
		return (
			<ListItem key={rowData.title} icon onPress={() => this.editItem(rowData, sectionId)}>
				<Body>
