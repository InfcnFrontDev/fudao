 ...
 * 我的能量场 > 资料填写
 */
export default class ExpectModal extends PureComponent {
    ...
    render() {
        ...
        let id = encodeURI(allExpectListStore.selectedItemName)
        return (
            <Modal
                animationType={'fade'}
                transparent={true}
                    ...
                    <ScrollView style={styles.child}>
                        ...
                        <View style={styles.closeBox}>
                            ...
                            <View style={styles.buttonView}>
                                <Button block onPress={() => allExpectListStore.modalShow = false} style={{marginRight:20,backgroundColor: '#ccc'}}>
                                    <Text>知道了</Text>
                                </Button>
                                <Button block onPress={() => allExpectListStore.modalShow = false}>
                                    <Text>教我自疗</Text>
                                </Button>
                            </View>
                        </View>
