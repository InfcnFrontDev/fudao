...
export default class TweetDetailsView extends Component{
    constructor(props) {
        super(props)
        this.state = {
            loadding: true,
                ...
                <ScrollView contentContainerStyle={styles.container}>
                    <View style={cardStyle.tweetContainer}>
                        <View style={cardStyle.topContainer}>
                            <Image source={{uri: util.getAvatarUrl(this.props.tweet.icon)}} style={cardStyle.icon} />
                            <View>
                                <View style={cardStyle.userContainer}>
                                    <Text style={cardStyle.name}>{this.props.tweet.text}</Text>
                    ...
                    <View style={styles.commentContainer}>
                        ...
                        <Comment loadding={this.state.loadding} comments={this.state.comments}/>
                    </View>  
                </ScrollView> 
            </View>
        )
...
const cardStyle = globalStyles.card
