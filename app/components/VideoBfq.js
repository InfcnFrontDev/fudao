                ...
                <View style={styles.bigBox}>
                    <View style={styles.View}>
                        <Image source={require('../assets/videoBj1.png')} style={styles.bj}>
                                <View style={{flexDirection: 'column',justifyContent:'center',alignItems:'center',backgroundColor:'red'}}>
                                ...
                                <Video source={{uri:urls.getImage('/high_quality_population/'+data.img)}} // 视频的URL地址，或者本地地址，都可以.
